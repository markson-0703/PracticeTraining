...
//        $this->token = \Yii::$app->security->generateRandomString();
   ...
   public function actionGetschool(){
    ...
    public function actionQueryplace(){
    $request = \Yii::$app->request;
