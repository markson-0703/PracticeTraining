    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="个人信息" name="first">
        ...
        <div class="displayShow">
          <el-button type="warning" style="width:200px; margin-bottom:10px;display: inline-block" @click="downloadPdf()">导出信息</el-button>
    ...
    export default {
        ...
        methods:{
            ...
            getInfo(){
                //展示个人信息
                let that = this
                that.$http.post('/yii/practice/detail/teacherdetail',{username:this.myForm.username})
                    .then((res)=>{
                        console.log(res.data)
