      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="个人信息" name="first">
          ...
          <div class="displayShow">
            <el-button type="warning" style="width:250px;margin-bottom:10px;display: inline-block" @click="downloadPdf()">导出信息</el-button>
    ...
    export default {
        ...
        methods:{
            ...
            showInfo(){
                //展示个人信息
                let that = this
                that.$http.post('/yii/practice/detail/studentdetail',{username:this.myForm.username})
                    .then((res)=>{
                        console.log(res.data)
